...
def replace_object_in_file(directory, filename):
    # directory = '/Users/byang8/seadas9.0.0Help/docs/general/overview'
    ...
    if content_old:
        for item in content_old:
            ...
            link = (content_split.split('<param name=')[0]).strip()
            if re.search('<param name="text"',content_split):
                ...
                content_text = (item.split('<param name="text"')[1])
                text = (content_text.split('<param name="')[0]).strip()
...
#             print(src_dir_path)
            if(dirname.endswith("images")):
                # dest_dir_path = "/Users/byang8/seadas9.0.0Help/docs/images"
                dest_dir_path = os.path.join(dir_target, 'docs', 'images')
                if(not os.path.isdir(dest_dir_path)):
                    os.mkdir(dest_dir_path)
                for filename in os.listdir(src_dir_path):
#                     print(filename)
                    if(os.path.isfile(os.path.join(src_dir_path, filename))):
                        if (not os.path.isdir(os.path.join(src_dir_path, filename))):
                ...
                # dest_dir_path = os.path.join("/Users/byang8/seadas9.0.0Help/docs", dirname)
...
#                             print("exists")
                            for filename in os.listdir(src_img_dir):
                                if (not os.path.exists(os.path.join(dest_img_dir, filename))):
                                    if (os.path.isdir(os.path.join(src_img_dir, filename))):
                                        shutil.copytree(os.path.join(src_img_dir, filename), os.path.join(dest_img_dir, filename))
                                    else:
...
# dir_src = "/Users/byang8/snap-10"
# dir_target = "/Users/byang8/seadas9.0.0Help/"
...
dir_opttbx = os.path.join(dir_src, "optical-toolbox")
...
#                     print("working on snap-help")
                    ...
                    print(src)
                    copy_resources()
                    # dest = "/Users/byang8/seadas9.0.0Help/snap-desktop/snap-help"
...
#             print(path)
            ...
            if(place != -1):  
                if(path.find("/snap-help/") == -1):
                    ...
                    print(src)
                    copy_resources()
                    dest = os.path.join("/Users/byang8/seadas9.1.0Help/snap-desktop", path[35:place])
        ...
        if file.endswith("toc.xml"):
            ...
            if(place != -1):
                if(path.find("seadas-processing") != -1):
                    ...
                    print(src)
                    copy_resources()
                    dest = "/Users/byang8/seadas9.1.0Help/seadas-toolbox/seadas-processing"
        ...
        if file.endswith("toc.xml"):
            ...
            if(place != -1):
                if(path.find("seadas-processing") == -1):
                    ...
                    print(src)
                    copy_resources()           
                    dest = os.path.join("/Users/byang8/seadas9.1.0Help/seadas-toolbox", path[37:place])
    ...
    for file in files:
        if file.endswith("toc.xml"):
            ...
            if(place != -1):
                ...
                print(src)
                copy_resources()
                dest = os.path.join(dir_target, 'snap-engine', path[34:place])
                print(dest)
...
for root, dirs, files in os.walk(dir_opttbx):
    for file in files:
        if (file.endswith("toc.xml")):
            path = os.path.join(root, file)
            if(path.find("optical-toolbox-dos") == -1):
                place = path.find("/target/")
                if(place != -1):
                    src = path[0:-8]
                    print(src)
                    copy_resources()
                    dest = os.path.join(dir_target, 'optical-toolbox', path[38:place])
                    print(dest)
