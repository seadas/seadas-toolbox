 ...
 */
@ActionID(category = "Video Tutorials Playlist", id = "ShowVideo02Action")
@ActionRegistration(
...
public class ShowVideo02Action extends AbstractSnapAction implements  LookupListener, Presenter.Menu {

    private static final String DEFAULT_PAGE_URL = "https://www.youtube.com/watch?v=xYjfd--JLFI";

    private final Lookup lookup;

    public ShowVideo02Action() {
        this(null);
    }

    public ShowVideo02Action(Lookup lookup) {
        putValue(ACTION_COMMAND_KEY, getClass().getName());
        putValue(SELECTED_KEY, false);
        putValue(NAME, Bundle.CTL_ShowVideo02Action_DisplayName());
        putValue(SHORT_DESCRIPTION, Bundle.CTL_ShowVideo02Action_ShortDescription());
    ...
    public void actionPerformed(ActionEvent event) {
        DesktopHelper.browse(Config.instance().preferences().get("seadas.video02", DEFAULT_PAGE_URL));
        updateEnabledState();
    }
