...
//    final static String SEADAS_OCSSW_KEEPFILEONSERVER_PROPERTY = "seadas.ocssw.keepFilesOnServer";
    ...
    public final static String SEADAS_OCSSW_TAG_DEFAULT_VALUE = "V2023.4";
    public final static String SEADAS_OCSSW_TAG_DEFAULT_VALUE_ALT = "V2023.3";
    public final static String SEADAS_OCSSW_TAG_DEFAULT_VALUE_ALT2 = "T2023.24";
