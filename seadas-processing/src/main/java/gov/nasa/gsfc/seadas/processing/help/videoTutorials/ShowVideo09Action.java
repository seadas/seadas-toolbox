 ...
 */
@ActionID(category = "Video Tutorials Playlist", id = "ShowVideo09Action")
@ActionRegistration(
...
public class ShowVideo09Action extends AbstractSnapAction implements  LookupListener, Presenter.Menu {

    private static final String DEFAULT_PAGE_URL = "https://www.youtube.com/watch?v=2UIfXDjfpEs";

    private final Lookup lookup;

    public ShowVideo09Action() {
        this(null);
    }

    public ShowVideo09Action(Lookup lookup) {
        putValue(ACTION_COMMAND_KEY, getClass().getName());
        putValue(SELECTED_KEY, false);
        putValue(NAME, Bundle.CTL_ShowVideo09Action_DisplayName());
        putValue(SHORT_DESCRIPTION, Bundle.CTL_ShowVideo09Action_ShortDescription());
    ...
    public void actionPerformed(ActionEvent event) {
        DesktopHelper.browse(Config.instance().preferences().get("seadas.video09", DEFAULT_PAGE_URL));
        updateEnabledState();
    }
