 ...
 */
@ActionID(category = "Video Tutorials Playlist", id = "ShowVideo01Action")
@ActionRegistration(
...
public class ShowVideo01Action extends AbstractSnapAction implements  LookupListener, Presenter.Menu {

    private static final String DEFAULT_PAGE_URL = "https://www.youtube.com/watch?v=GZG2saE9ecc";

    private final Lookup lookup;

    public ShowVideo01Action() {
        this(null);
    }

    public ShowVideo01Action(Lookup lookup) {
        putValue(ACTION_COMMAND_KEY, getClass().getName());
        putValue(SELECTED_KEY, false);
        putValue(NAME, Bundle.CTL_ShowVideo01Action_DisplayName());
        putValue(SHORT_DESCRIPTION, Bundle.CTL_ShowVideo01Action_ShortDescription());
    ...
    public void actionPerformed(ActionEvent event) {
        DesktopHelper.browse(Config.instance().preferences().get("seadas.video01", DEFAULT_PAGE_URL));
        updateEnabledState();
    }
