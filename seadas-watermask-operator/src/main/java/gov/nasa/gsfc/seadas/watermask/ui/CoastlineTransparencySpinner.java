...
public class CoastlineTransparencySpinner {
    ...
    public CoastlineTransparencySpinner(LandMasksData landMasksData) {
        ...
        jLabel = new JLabel(Landmask_Controller.PROPERTY_COAST_MASK_TRANSPARENCY_LABEL);
        jLabel.setToolTipText(Landmask_Controller.PROPERTY_COAST_MASK_TRANSPARENCY_TOOLTIP);
