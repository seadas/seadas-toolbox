...
public class HarmonySubsetServiceDiaglog extends JDialog{

    public static final String TITLE = "OB_CLOUD Data Subsetter - powered by Harmony Search"; /*I18N*/
    ...
    public HarmonySubsetServiceDiaglog(){
