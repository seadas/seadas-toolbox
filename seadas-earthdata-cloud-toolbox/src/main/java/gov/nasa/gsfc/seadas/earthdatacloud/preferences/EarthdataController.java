...
/**
 * * Panel handling EarthdataCloud preferences. Sub-panel of the "EarthdataCloud"-panel.
 *
 * @author Daniel Knowles
 */


@OptionsPanelController.SubRegistration(location = "EarthdataCloud",
        displayName = "#Options_DisplayName_EarthdataCloud",
        keywords = "#Options_Keywords_EarthdataCloud",
        keywordsCategory = "Earthdata",
        id = "Tab1")
@org.openide.util.NbBundle.Messages({
        "Options_DisplayName_EarthdataCloud=EarthdataCloud",
        "Options_Keywords_EarthdataCloud=Earthdata, cloud"
})
public final class EarthdataController extends DefaultConfigController {
    ...
    public HelpCtx getHelpCtx() {
        return new HelpCtx("EarthdataCloudTab1Preferences");
    }
